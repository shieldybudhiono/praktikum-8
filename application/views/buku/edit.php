        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="pengarang" class="form-control" value="<?php echo $dataBuku['pengarang']; ?>" placeholder="Masukan Pengarang..." required>
            </div>
            <div class="form-group">
              <label>Penerbit</label>
              <input type="text" name="penerbit" class="form-control" placeholder="Masukan penerbit..." required value="<?php echo $dataBuku['penerbit']; ?>">
            </div>
            <div class="form-group">
              <label>Alamat</label>
              <input type="text" name="tahun_terbit" class="form-control" placeholder="Masukan tahun terbit..." required value="<?php echo $dataBuku['tahun_terbit']; ?>">
            </div>
          </div>
        </div>
      </div>
